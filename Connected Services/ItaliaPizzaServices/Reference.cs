...
namespace ItaliaPizzaClient.ItaliaPizzaServices {
    ...
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.Runtime.Serialization", "4.0.0.0")]
    [System.Runtime.Serialization.DataContractAttribute(Name="TransactionDTO", Namespace="http://schemas.datacontract.org/2004/07/")]
    [System.SerializableAttribute()]
    ...
    public interface IMainManager {
        ...
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/ISupplierManager/RegisterSupplier", ReplyAction="http://tempuri.org/ISupplierManager/RegisterSupplierResponse")]
        int RegisterSupplier(ItaliaPizzaClient.ItaliaPizzaServices.SupplierDTO supplierDTO);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/ISupplierManager/RegisterSupplier", ReplyAction="http://tempuri.org/ISupplierManager/RegisterSupplierResponse")]
        System.Threading.Tasks.Task<int> RegisterSupplierAsync(ItaliaPizzaClient.ItaliaPizzaServices.SupplierDTO supplierDTO);
        ...
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IFinanceManager/RegisterTransaction", ReplyAction="http://tempuri.org/IFinanceManager/RegisterTransactionResponse")]
        bool RegisterTransaction(ItaliaPizzaClient.ItaliaPizzaServices.TransactionDTO transaction);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IFinanceManager/RegisterTransaction", ReplyAction="http://tempuri.org/IFinanceManager/RegisterTransactionResponse")]
        System.Threading.Tasks.Task<bool> RegisterTransactionAsync(ItaliaPizzaClient.ItaliaPizzaServices.TransactionDTO transaction);
        ...
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/ICustomerManager/RegisterCustomer", ReplyAction="http://tempuri.org/ICustomerManager/RegisterCustomerResponse")]
        int RegisterCustomer(ItaliaPizzaClient.ItaliaPizzaServices.CustomerDTO customerDTO, ItaliaPizzaClient.ItaliaPizzaServices.AddressDTO addressDTO);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/ICustomerManager/RegisterCustomer", ReplyAction="http://tempuri.org/ICustomerManager/RegisterCustomerResponse")]
        System.Threading.Tasks.Task<int> RegisterCustomerAsync(ItaliaPizzaClient.ItaliaPizzaServices.CustomerDTO customerDTO, ItaliaPizzaClient.ItaliaPizzaServices.AddressDTO addressDTO);
    ...
    public partial class MainManagerClient : System.ServiceModel.ClientBase<ItaliaPizzaClient.ItaliaPizzaServices.IMainManager>, ItaliaPizzaClient.ItaliaPizzaServices.IMainManager {
        ...
        public int RegisterSupplier(ItaliaPizzaClient.ItaliaPizzaServices.SupplierDTO supplierDTO) {
            return base.Channel.RegisterSupplier(supplierDTO);
        }
        
        public System.Threading.Tasks.Task<int> RegisterSupplierAsync(ItaliaPizzaClient.ItaliaPizzaServices.SupplierDTO supplierDTO) {
            return base.Channel.RegisterSupplierAsync(supplierDTO);
        }
        ...
        public bool RegisterTransaction(ItaliaPizzaClient.ItaliaPizzaServices.TransactionDTO transaction) {
            return base.Channel.RegisterTransaction(transaction);
        }
        
        public System.Threading.Tasks.Task<bool> RegisterTransactionAsync(ItaliaPizzaClient.ItaliaPizzaServices.TransactionDTO transaction) {
            return base.Channel.RegisterTransactionAsync(transaction);
        }
        ...
        public int RegisterCustomer(ItaliaPizzaClient.ItaliaPizzaServices.CustomerDTO customerDTO, ItaliaPizzaClient.ItaliaPizzaServices.AddressDTO addressDTO) {
            return base.Channel.RegisterCustomer(customerDTO, addressDTO);
        }
        
        public System.Threading.Tasks.Task<int> RegisterCustomerAsync(ItaliaPizzaClient.ItaliaPizzaServices.CustomerDTO customerDTO, ItaliaPizzaClient.ItaliaPizzaServices.AddressDTO addressDTO) {
            return base.Channel.RegisterCustomerAsync(customerDTO, addressDTO);
        }
